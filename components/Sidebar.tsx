...
// const chats = useQuery(api.chats.listChats);
 ...
 // const handleNewChat =async () => {
   ...
   // router.push(`/dashboard/chat/${chatId}`);
    // TODO: Add functionality for creating a new chat
   // closeMobileNav();
 // };
...
><PlusIcon className="mr-2 h-4 w-4" /> New Chat</Button>
...
/*export const listChats = query({
  ...
  return (
    <>
      ...
      {isMobileNavOpen && (
        <div
          className="fixed inset-0 bg-red-500/20 z-40 md:hidden"
          onClick={closeMobileNav}
        />
      )}
      ...
      >
        <div className="p-4 border-b border-gray-200/50">
          <Button
            onClick={handleNewChat}
            className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-200/50 shadow-sm hover:shadow transition-all
             duration-200"
          >
